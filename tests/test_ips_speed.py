...
ips = runpy.run_path(str(script), run_name="ips_speed_test")
module_globals = ips["show_speed"].__globals__
...
baseline = ips["Check"](
    ...
    "gateway",
    10,
    ips["latency_metrics"]([9.0, 10.0, 11.0], sent=3),
    "pass",
)
loaded = ips["Check"](
    "gateway",
    ...
    "gateway",
    30,
    ips["latency_metrics"]([10.0, 30.0, 90.0], sent=3),
    "degraded",
)
